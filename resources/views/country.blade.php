...
<head>
    ...
    <title>Pilates Atlas - Worldwide Pilates Studio Directory</title>
    <meta name="description" content="Comprehensive directory of Pilates studios from major cities around the world. Find reformer, classical, and contemporary Pilates classes near you.">
    <meta name="author" content="Pilates Atlas">

    <meta property="og:title" content="Pilates Atlas - Worldwide Pilates Studio Directory">
    <meta property="og:description" content="Comprehensive directory of Pilates studios from major cities around the world.">
    <meta property="og:type" content="website">
    <meta property="og:image" content="https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1afb47aa-0b69-4a12-ab77-852517ff01bc/id-preview-383d3fa0--9e4bc063-0448-4993-9f0f-3a42b6189013.lovable.app-1761762105152.png">

    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@lovable_dev">
    <meta name="twitter:image" content="https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1afb47aa-0b69-4a12-ab77-852517ff01bc/id-preview-383d3fa0--9e4bc063-0448-4993-9f0f-3a42b6189013.lovable.app-1761762105152.png">
    <script type="module" crossorigin="" src="/assets/index-rhsekdHI.js"></script>
    ...
    <style>
        ...
        [data-lov-selected]::before {
            ...
            height: 100%;
            border-radius: 0px;
            outline: 1px solid #0da2e7 !important;
            z-index: 10000;
            pointer-events: none;
        }

        :is(input, img, textarea, select, video, audio, iframe, canvas, svg)[data-lov-hovered] {
            outline: 2px solid #0da2e7 !important;
            outline-offset: 0 !important;
        }

        :is(input, img, textarea, select, video, audio, iframe, canvas, svg)[data-lov-selected] {
            outline: 1px solid #0da2e7 !important;
            outline-offset: 0 !important;
        }
        ...
        [data-lov-hovered][data-full-width]::before,
        [data-lov-selected][data-full-width]::before {
        ...
        /* Child element highlighting on hover */
        [data-lov-hovered]>* {
            position: relative;
        }
        ...
        [data-lov-hovered]>*::before {
            ...
            height: 100%;
            border-radius: 0px;
            outline: 1px dotted #0da2e7 !important;
...
<body>
    <div id="root">
        ...
        <div style="max-width: 900px; margin: 0px auto; padding: 20px; font-family: monospace, sans-serif; background-color: rgb(255, 255, 255);">
            <div style="border-bottom: 2px solid rgb(0, 0, 0); padding-bottom: 10px; margin-bottom: 20px;">
            ...
            <div style="background-color: rgb(240, 240, 240); padding: 15px; margin-bottom: 20px; border: 1px solid rgb(204, 204, 204);">
                <form action="{{ route('city.show_studios') }}"  method="GET">
                    <!-- <div style="margin-bottom: 10px;">
                        <label style="display: block; margin-bottom: 5px; font-size: 14px; font-weight: bold;">Search by studio, area or city (e.g. Lisbon, SoHo)</label><input type="text" style="width: 100%; padding: 8px; font-size: 14px; border: 1px solid rgb(153, 153, 153); font-family: inherit;" value="">
                    </div> -->
                    <div style="display: flex; gap: 10px; align-items: flex-end;">
                        <div style="flex: 1 1 0%;">
                            <label style="display: block; margin-bottom: 5px; font-size: 14px; font-weight: bold;">City</label>
                                <!-- @php 
                                   // Extract unique city names from the studios collection
                                   $uniqueCities = $studios->pluck('city.name', 'city.id')->unique();                                 
                                @endphp -->                              
    ...
    <a id="lovable-badge" target="_blank" href="https://lovable.dev/projects/9e4bc063-0448-4993-9f0f-3a42b6189013?utm_source=lovable-badge" style="display: none;">
