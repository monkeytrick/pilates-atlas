...
<body>
    <div id="root">
        ...
        <div style="border-bottom: 2px solid rgb(0, 0, 0); padding-bottom: 10px; margin-bottom: 20px;">
            <!-- Log-in or register links -->
             <div id="nav-links" style="float: right; margin-top: -10px; margin-bottom: 10px;">
                <x-auth-links />
             </div>            
                <a href="{{ route('home') }}">
                    <h1 style="font-size: 24px; font-weight: bold; margin: 0px 0px 5px; color: rgb(0, 0, 0);">
                        Pilates Atlas
                    </h1>
                </a>
                <p style="margin: 0px; font-size: 14px; color: rgb(102, 102, 102);">Worldwide Pilates studio directory</p>
            </div>
        @yield('results-header')

        @yield('search-box')

        @yield('studio-results-count')
